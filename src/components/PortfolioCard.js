    ...
    return(
        <div id="cardId" className="col-8 col-sm-8 col-md-6 col-lg-4">
            <div className="card">
                ...
                <h6 className="card-subtitle mb-2 text-muted card-info"><a id="resumeLink" href="https://drive.google.com/file/d/1DGyeVUHOAvDh5NOzTKIwOKPH3Pss1fa_/view?usp=sharing" target="_blank" rel="noopener noreferrer"><i className="fas fa-file-pdf"></i><span> Resume</span></a></h6>
                </div>
            </div>
        </div>
    )
